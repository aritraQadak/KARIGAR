...
export default function Customers() {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-500">{t('customers.sampleNotice', 'Sample customer reviews for this prototype.')}</p>
      {/* Customer Cards Grid */}
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className="text-right">
                ...
                <span className="text-sm font-bold text-gray-900 dark:text-white">{formatNumber(cust.ordersCount, i18n.language)} {t('common.units')}</span>
              </div>
            </div>
            ...
            <div className="p-3.5 bg-seller-muted  rounded-xl border border-gray-100 dark:border-gray-700/80 space-y-1.5">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-bold text-gray-700 dark:text-gray-300">
                  {t('customers.lastOrder')}: {translateCraftType(cust.favoriteCraft, i18n.language)}
                </span>
                <div className="flex items-center gap-0.5 text-seller-accent-ink">
                  ...
                  <span className="text-[11px] font-bold text-gray-700 dark:text-gray-300 ml-1">
                    {formatNumber(cust.rating, i18n.language)}
                  </span>
                </div>
              </div>
